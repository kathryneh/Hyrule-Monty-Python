...
public class SwingSpinner extends AWTComponent implements VirtualSpinner {
	...
	public void init (Object[] choices) {
		Component c = new JSpinner (choices);
		super.init(c);		
	}
	public void setEditable (boolean newVal) {
		getSpinner().setEditable(newVal);
	}
	public boolean isEditable() {
		return getSpinner().isEditable();
	}
	public int getItemCount() {
		return getSpinner().getItemCount();
	}
	...
	*/
	...
	public void removeItem(Object item) {
		getSpinner().removeItem(item);
	}
	public void addItemListener (ItemListener item) {
		getSpinner().addItemListener(item);
	}
	public void addItemListener (Object item) {
		getSpinner().addItemListener((ItemListener)item);
	}
	public void setMaximumRowCount (int num) {
		getSpinner().setMaximumRowCount(num);
	}
	*/
