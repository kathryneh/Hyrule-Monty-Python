...
public class SwingList extends SwingComponent implements VirtualList {
	...
	public Object getPathForLocation (int x, int y) {
		return getList().getPathForLocation(x, y);
	}
	public Object getSelectionPath() {
		return getList().getSelectionPath();
	}
	public Object[] getSelectionPaths() {
		return getList().getSelectionPaths();
	}
	...
	public Object getLastSelectedPathComponent() {
		return getList().getLastSelectedPathComponent();
	}
	*/
