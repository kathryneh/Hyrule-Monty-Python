...
public class SwingFormattedTextField extends SwingTextField 
	implements VirtualFormattedTextField {
	...
	public static SwingFormattedTextField virtualFormattedTextField (JFormattedTextField theTextField) {	
		return (SwingFormattedTextField) AWTComponent.virtualComponent(theTextField);		
