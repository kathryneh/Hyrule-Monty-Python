...
public class SwingTable extends AWTContainer implements VirtualTable {
	...
	public Object getPathForLocation (int x, int y) {
		return getTable().getPathForLocation(x, y);
	}
	public Object getSelectionPath() {
		return getTable().getSelectionPath();
	}
	public Object[] getSelectionPaths() {
		return getTable().getSelectionPaths();
	}
	...
	public Object getLastSelectedPathComponent() {
		return getTable().getLastSelectedPathComponent();
	}
	*/
	...
	*/
	...
	/*
	public void treDidChange() {
		getTable().tableDidChange();
	}
	*/
	...
	*/
	...
	public void addTableSelectionListener(TableSelectionListener listener) {
		getTable().addTableSelectionListener(listener);
	}
	public void addTableSelectionListener(Object listener) {
	...
	public void addTableExpansionListener(TableExpansionListener listener) {
		getTable().addTableExpansionListener(listener);
	}
	public void addTableExpansionListener(Object listener) {
