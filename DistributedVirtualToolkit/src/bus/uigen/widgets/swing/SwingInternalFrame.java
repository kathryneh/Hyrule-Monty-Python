...
public class SwingInternalFrame extends SwingComponent implements VirtualInternalFrame {
	//JInternalFrame getFrame();
	VirtualContainer contents;
	public SwingInternalFrame (JInternalFrame theFrame) {
		super (theFrame);
		//getFrame() = theFrame;
		contents = AWTContainer.virtualContainer(getJInternalFrame().getContentPane());
    ...
    public void  setContentPane(VirtualContainer container) {
    	getJInternalFrame().setContentPane((Container) container.getPhysicalComponent());
    }
	...
	*/
    ...
    public void setMenuBar(VirtualMenuBar newVal) {
    	menuBar = newVal;
    	getJInternalFrame().setJMenuBar ((JMenuBar) newVal.getPhysicalComponent());
    }
	...
	public void setLayout(VirtualLayout l) {
		if(!(l==null || l instanceof AWTLayout)) {throw new IllegalArgumentException("Argument must be of SWT type");}
