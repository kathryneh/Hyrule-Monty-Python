...
public  class SwingMenuBar extends AUniversalWidget implements VirtualMenuBar {
	//MenuBar menu;
	...
	*/
	...
	public UniversalWidget getComponentAtIndex(int i) {
		...
		//return AUniversalWidget.universalWidget(getMenuBar().getComponentAtIndex(i));
		return AUniversalWidget.universalWidget(getMenuBar().getComponent(i));
	}
	...
	public static AWTMenuBar virtualMenuBar (MenuBar theMenuBar) {
		return (AWTMenuBar) AUniversalWidget.universalWidget(theMenuBar);
	}
	@Override
