...
public class SwingDelegatePanel extends SwingComponent implements VirtualDelegatePanel {
	...
	public static SwingDelegatePanel virtualDelegatePanel (DelegateJPanel thePanel) {	
		SwingDelegatePanel retVal = (SwingDelegatePanel) AWTComponent.virtualComponent(thePanel);	
