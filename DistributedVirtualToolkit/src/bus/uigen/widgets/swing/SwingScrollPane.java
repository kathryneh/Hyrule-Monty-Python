...
public class SwingScrollPane extends AWTContainer implements VirtualScrollPane {
	...
	/*
	public static ASwingScrollPane virtualScrollPane (JScrollPane theScrollPane, VirtualComponent scrolledComponent) {	
		ASwingScrollPane retVal = (ASwingScrollPane) AnAWTComponent.virtualComponent(theScrollPane);	
		retVal.setScrolledComponent(scrolledComponent);
		return retVal;
	}
	*/
	public static SwingScrollPane virtualScrollPane (JScrollPane theScrollPane) {	
		SwingScrollPane retVal = (SwingScrollPane) AWTComponent.virtualComponent(theScrollPane);	
		//retVal.setScrolledComponent(scrolledComponent);
		return retVal;
	}
