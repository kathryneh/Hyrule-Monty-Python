...
public class AWTScrollPane extends AWTContainer implements VirtualScrollPane {
	...
	/*
	public VirtualComponent getScrolledComponent () {
		return AnAWTComponent.virtualComponent(getScrollPane().getComponent(0));
	...
	*/
	...
	/*
	public static AnAWTScrollPane virtualScrollPane (ScrollPane theScrollPane, VirtualComponent scrolledComponent) {	
		AnAWTScrollPane retVal =  (AnAWTScrollPane) AnAWTComponent.virtualComponent(theScrollPane);	
