...
public abstract class AWTMenuContainer implements VirtualMenuContainer {
	...
	*/
	...
	public static AWTMenuContainer virtualMenuContainer (MenuContainer theMenuContainer) {
		return (AWTMenuContainer) AUniversalWidget.universalWidget(theMenuContainer);
	}
