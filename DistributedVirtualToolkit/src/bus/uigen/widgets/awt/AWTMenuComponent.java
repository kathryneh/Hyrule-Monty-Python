...
public abstract class AWTMenuComponent extends AUniversalWidget implements VirtualMenuComponent {
	...
	*/
	...
	public static AWTMenuComponent virtualMenuComponent (MenuComponent theMenuComponent) {
		return (AWTMenuComponent) AUniversalWidget.universalWidget(theMenuComponent);
	}
	/*
