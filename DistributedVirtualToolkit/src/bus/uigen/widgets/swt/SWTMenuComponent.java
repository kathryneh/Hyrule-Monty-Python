...
public class SWTMenuComponent extends AUniversalWidget implements VirtualMenuComponent {
	...
	*/
	...
	public static SWTMenuComponent virtualMenuComponent (MenuComponent theMenuComponent) {
		return (SWTMenuComponent) AUniversalWidget.universalWidget(theMenuComponent);
	}
	/*
	static transient Hashtable<MenuComponent, AnAWTMenuComponent> MenuComponentsToVirtualMenuComponents = new Hashtable();
	
	public static AnAWTMenuComponent virtualMenuComponent (MenuComponent theMenuComponent) {
			if (theMenuComponent == null) return null;
			AnAWTMenuComponent vc = MenuComponentsToVirtualMenuComponents.get(theMenuComponent);
			if (vc == null) {
				
				vc = new AnAWTMenuComponent (theMenuComponent);
				MenuComponentsToVirtualMenuComponents.put(theMenuComponent, vc);			
			}
			return vc;
