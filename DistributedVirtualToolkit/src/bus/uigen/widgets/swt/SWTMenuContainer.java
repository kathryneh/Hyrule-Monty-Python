...
public abstract class SWTMenuContainer implements VirtualMenuContainer {
	...
	public void setEnabled (boolean newVal) {
		getMenuContainer().setEnabled(newVal);
	}
	public void enable () {
		setEnabled(true);
	}
	public void postEvent(Event event) {
		getMenuContainer().postEvent(event);
	}
	public void setLabel (String newVal) {
		getMenuContainer().setLabel(newVal);
	}
	...
	*/
	...
	public static SWTMenuContainer virtualMenuContainer (MenuContainer theMenuContainer) {
		return (SWTMenuContainer) AUniversalWidget.universalWidget(theMenuContainer);
	}
