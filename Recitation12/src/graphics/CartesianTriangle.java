...
public class CartesianTriangle extends CartesianShape implements Triangle {
	...
	public void animateSetX(int newX){
		...
		line1.animateSetX(line1.getX() + dx);
		line2.animateSetX(line2.getX() + dx);
		line3.animateSetX(line3.getX() + dx);
	}
	
	public void animateSetY(int newY){
		int dy = newY - getY();
		
		line1.animateSetY(line1.getY() + dy);
		line2.animateSetY(line2.getY() + dy);
		line3.animateSetY(line3.getY() + dy);
	}
