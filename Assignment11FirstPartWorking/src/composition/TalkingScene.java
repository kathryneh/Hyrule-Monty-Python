...
public class TalkingScene extends Scene implements TalkingScenic{
	...
	public TalkingScene(){
		...
		knightAvatarCollection.push("Bob", "knight");
		knightAvatarCollection.push("Link", "knight");
		knightAvatarCollection.push("Joe", "knight");
	...
	public void KnightFallOffCliff(){
		...
		//fallenCollection.notifyAllListeners(new VectorChangeEvent(this, 1, fallenCollection.al.size()-1, null, fallenAvatar, fallenCollection.al.size()));
