...
/*	public void removeElement() {
	...
	*/
	...
	public void PushAnimatedFallenGuard(AlignedTalkingGuard guard) {
			super.push(guard);
			((Talkable)objectArray[size]).setAnimatedX(550-size*50);
			((Talkable)objectArray[size]).setAnimatedY(550);
			((Talkable)objectArray[size]).setAnimatedChatX(165);
			((Talkable)objectArray[size]).setAnimatedChatY(300);
			//System.out.println((avatarArray[size].getChatHistory().getX()));
			//avatarArray[size].push(650, 500, "I've fallen!");
	...
	public void pushAnimatedFallen(AlignedTalkingKnight avatar) {
		//objectArray[size] = avatar;
		super.push(avatar);
		((Talkable) objectArray[size]).setAnimatedX(550-size*50);
		((Talkable) objectArray[size]).setAnimatedY(550);
		((Talkable) objectArray[size]).setAnimatedChatX(265);
		((Talkable) objectArray[size]).setAnimatedChatY(300);
		//System.out.println((avatarArray[size].getChatHistory().getX()));
		//avatarArray[size].push(650, 500, "I've fallen!");
	...
	public void pushAnimatedCrossed(AlignedTalkingKnight leadingKnight) {
		super.push(leadingKnight);
		((Talkable)objectArray[size]).setAnimatedX(675-size*50);
		((Talkable)objectArray[size]).setAnimatedY(290);
		((Talkable)objectArray[size]).setAnimatedChatX(390);
		((Talkable)objectArray[size]).setAnimatedChatY(40);
		size++;
