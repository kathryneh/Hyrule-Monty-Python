...
public void findPlus() {
	tokens.PlusToken p1 = new tokens.PlusToken(curChar);
...
public void findMinus() {
	tokens.MinusToken m1 = new tokens.MinusToken(curChar);
...
public void findNumber() {
	...
	tokens.NumberToken n1 = new tokens.NumberToken(numberString);
...
public void findCommand() {
	...
	tokens.CommandToken c1 = new tokens.CommandToken(commandString);
...
public void findQuotedString() {
	...
	tokens.StringToken qs1 = new tokens.StringToken(quotedString);
