...
public class GuardAvatar implements Avatar {
	int startX;
	int startY;
	int initialX;
	int initialY;
	...
	private void buildGuardAvatar() {
		...
		this.name = new bodyparts.Name(startX, startY-20, 30, 20, "Mido");
	...
	public void setX(int moveX) {
		...
		startX = startX + moveX;
		buildGuardAvatar();
		// testAvatar(initialX, initialY, moveX, 0);
	}
	...
	public void setY(int moveY) {
		...
		startY = startY + moveY;
		buildGuardAvatar();
		// testAvatar(initialX, initialY, 0, moveY);
		// startY = movedY;
	}
	 ...
	 * the movement. boolean passed = true; if (leftArm.getStartX() == startX +
	 * moveX) {System.out.println("Passed Left Arm X Test.");} else{passed =
	 * false;} if (leftArm.getStartY() == startY + headHeight*2 + moveY)
	 * {System.out.println("Passed Left Arm Y Test.");} else{passed = false;} if
	 * (rightArm.getStartX() == startX + bodyWidth + moveX )
	 * {System.out.println("Passed Right Arm X Test.");} else{passed = false;}
	 * if (rightArm.getStartY() == startY + headHeight*2 + moveY)
	 * {System.out.println("Passed Right Arm Y Test.");} else{passed = false;}
	 * if (leftLeg.getStartX() == startX + headWidth/3 + moveX)
	 * {System.out.println("Passed Left Leg X Test.");} else{passed = false;} if
	 * (leftLeg.getStartY() == startY+ bodyHeight + moveY)
	 * {System.out.println("Passed Left Leg Y Test.");} else{passed = false;} if
	 * (rightLeg.getStartX() == startX+ (2*headWidth/3)+moveX)
	 * {System.out.println("Passed Right Leg X Test.");} else{passed = false;}
	 * if (rightLeg.getStartY() == startY + bodyHeight + moveY)
	 * {System.out.println("Passed Right Leg Y Test.");} else{passed = false;}
	 * if (body.getStartX() == startX + moveX)
	 * {System.out.println("Passed Body X Test.");} else{passed = false;} if
	 * (body.getStartY() == startY+headHeight+moveY)
	 * {System.out.println("Passed Body Y Test.");} else{passed = false;} if
	 * (sword.getStartX() == startX+ armLength+moveX)
	 * {System.out.println("Passed Sword X Test.");} else{passed = false;} if
	 * (sword.getStartY() == startY + headHeight*2+armLength +moveY)
	 * {System.out.println("Passed Sword Y Test.");} else{passed = false;} if
	 * (head.getStartX() == startX + moveX )
	 * {System.out.println("Passed Head X Test.");} else{passed = false;} if
	 * (head.getStartY() == startY + moveY )
	 * {System.out.println("Passed Head Y Test.");} else{passed = false;} if
	 * (name.getStartX() == startX + moveX )
	 * {System.out.println("Passed Name X Test.");} else{passed = false;} if
	 * (name.getStartY() == startY-20 + moveX )
	 * {System.out.println("Passed Name Y Test.");} if
	 * (!passed){System.out.println("Test failed.");}
